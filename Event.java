...
public abstract class Event {
    ...
    public static final int GIO_TO_HUNG_VUONG = 7;
    ...
    public static boolean isSummerEvent() {
        return isEvent() && instance instanceof SummerEvent;
    }
    ...
    public void initRandomItem() {
        ...
        itemsRecFromCoinItem.add(0.1, ItemName.BAT_BAO);
         itemsRecFromCoinItem.add(1, ItemName.TUI_VAI_CAP_5);
        itemsRecFromCoinItem.add(2, ItemName.LONG_KHI);
        itemsRecFromCoinItem.add(10, ItemName.HOA_TUYET);
        itemsRecFromCoinItem.add(10, ItemName.CAT_NGU_SAC);
